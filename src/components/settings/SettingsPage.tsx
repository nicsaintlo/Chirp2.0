...
export function SettingsPage() {
  ...
  return (
    <div className="flex flex-col gap-6 pb-8">
        ...
        <Card>
          ...
          <Row>
            <div>
              <div className="flex items-center gap-2">
                ...
                {store.aiCleanup && (
                  <span className="flex items-center gap-1">
                    {store.aiBackend === 'google' ? (
                      <>
                        <div className="h-1.5 w-1.5 rounded-full bg-chirp-success" />
                        <span className="text-[11px] text-[#aaa]">Active via Gemma</span>
                      </>
                    ) : cleanupStarting ? (
                      <>
                        <div className="h-1.5 w-1.5 rounded-full bg-chirp-amber-400 animate-pulse" />
              ...
              <div className="text-[11px] text-[#aaa] mt-0.5">Polish grammar and filler words with Gemma</div>
            </div>
            <Toggle
          ...
          <Row>
            <div>
              <div className="text-[13px] font-medium text-[#1a1a1a]">AI Backend</div>
              <div className="text-[11px] text-[#aaa] mt-0.5">Cloud — Gemini for speech, Gemma for text cleanup</div>
            </div>
            <div className="flex items-center gap-1.5">
              <div className="h-1.5 w-1.5 rounded-full bg-chirp-success" />
              <span className="text-[12px] text-[#888]">Google AI</span>
            </div>
          </Row>
      ...
      {/* ── MODELS ─────────────────────────────────── */}
      {store.aiBackend === 'local' && <div className="animate-slide-up stagger-5">
