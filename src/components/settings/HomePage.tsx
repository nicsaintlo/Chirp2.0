...
export function HomePage() {
  ...
  // Ready when using Google backend with a token, or local model is downloaded
  const isDownloaded = store.aiBackend === 'google' ? !!store.googleToken : store.modelDownloaded[store.model]
